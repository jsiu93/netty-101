...
public class QueueTaskClientApp {

    private final String host;
    private final int port;

    public QueueTaskClientApp(String host, int port) {
        this.host = host;
        this.port = port;
    }
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            bs.group(group)
                    ...
                    .handler(new ClientQueueTaskInitializer());
...
//            future.channel().writeAndFlush(Unpooled.copiedBuffer("hello from client", CharsetUtil.UTF_8));
    ...
    public static void main(String[] args) throws Exception {
        new QueueTaskClientApp("127.0.0.1", 8888).run();
    }
}
